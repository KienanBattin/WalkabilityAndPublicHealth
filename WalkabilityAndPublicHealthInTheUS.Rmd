...
ggplot(data=disease_with_walkability,aes(x=Topic))+geom_bar()+coord_flip()
ggplot(data=disease_with_walkability,aes(x=BLKGRPCE))+geom_bar()+xlab("Scale of Walkability")+ylab("Frequency")+theme(axis.ticks.x = element_line())+scale_y_continuous(labels = number)
summary(as.factor(disease_with_walkability$BLKGRPCE))
```
